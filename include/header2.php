...
<div class="content"> -->
  ...
  <div class="content">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color:purple !important;">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item nn">
                <a class="nav-link bgg text-white" aria-current="page" href="index.php">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white" href="./cart.php" target="_blank">Shop</a>
              </li><li class="nav-item">
                <a class="nav-link text-white" href="./checkout.php" target="_blank">Checkout</a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link text-white" href="./contact.php" target="_blank">Contact Us</a>
              </li>
            </ul>
            <?php
      ...
      <nav aria-label="breadcrumb" class="bcolor">
        ...
        <span><a href="./index.php" target="_blank" class="bpt text-muted" style="transition:all 0.4s ease-out !important;">Home</a></span>
        <span>/</span>
        <span"><a href="./contact.php" target="_blank" class="bst text-muted" style="transition:all 0.4s ease-out !important;"> Contact</a></span></div>
